    ...
    <header className="flex flex-col bg-background shrink-0 transition-colors duration-300">
      ...
      <div className="h-16 flex items-center justify-between px-6 border-b border-border-main">
        <div className="flex items-center gap-3">
          <h1 className="text-xl font-semibold text-text-main tracking-tight">Website Redesign</h1>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center bg-surface rounded-md p-1 border border-border-main">
            <button className="p-1.5 rounded bg-border-main text-text-main shadow-sm transition-all">
              <LayoutGrid className="w-4 h-4" />
            </button>
            <button className="p-1.5 rounded text-text-muted hover:text-text-main transition-all">
          ...
          <button 
            ...
            className={`flex items-center gap-2 px-3 py-1.5 text-sm rounded-md transition-all border ${
              filterHighPriority 
                ...
                : 'text-text-muted hover:text-text-main border-border-main hover:bg-surface'
            }`}
          >
